...
const Home = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            ...
            <span className="text-2xl font-bold text-gray-800">THE TASTE</span>
          </div>
  ...
  // Hero Section
  const HeroSection = () => (
    <div className="relative bg-gradient-to-r from-pink-50 to-orange-50 py-8 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-2 md:gap-12 items-center">
          <div>
            <h1 className="text-3xl lg:text-5xl font-bold text-gray-800 mb-2 md:mb-6">
              Welcome to <span className="text-pink-600">THE TASTE</span>
            </h1>
            <p className="text-sm lg:text-xl text-gray-600 mb-2 md:mb-8">
              Indulge in our freshly baked cakes, pastries, and cookies made
          ...
          <div className="">
            <img
              src="/cake.png"
              alt="Bakery"
              className="filter drop-shadow-[0_5px_15px_rgba(236,72,153,0.6)] animate-pulse"
            />
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <p className="text-gray-600">
              Only the finest ingredients go into our baked goods
            </p>
          </div>
          <div className="text-center p-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Your neighborhood bakery since 2010
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              THE TASTE was born from a simple passion for creating delicious,
              high-quality baked goods that bring joy to our customers' lives.
              What started as a small family bakery has grown into a beloved
              local institution.
            </p>
            <p className="text-gray-600 mb-4">
              We believe that the best ingredients make the best products.
              That's why we source our flour, butter, and other essentials from
              trusted suppliers who share our commitment to quality.
            </p>
            <p className="text-gray-600">
              Every morning, our skilled bakers arrive before dawn to prepare
              fresh bread, pastries, and cakes. We take pride in traditional
              baking methods while embracing modern techniques to create unique
              flavors.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                ...
                <span>123 Baker Street, Cake City, CC 12345</span>
              </div>
              <div className="flex items-center">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                ...
                <Facebook className="h-6 w-6 text-pink-600 hover:text-pink-700 cursor-pointer" />
                <Twitter className="h-6 w-6 text-pink-600 hover:text-pink-700 cursor-pointer" />
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <ChefHat className="h-8 w-8 text-pink-600 mr-2" />
              <span className="text-2xl font-bold">THE TASTE</span>
            </div>
            <p className="text-gray-400">
              Your neighborhood bakery creating delicious memories since 2010.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <span className="text-gray-400">Cakes</span>
              </li>
              <li>
                <span className="text-gray-400">Pastries</span>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p>Cake City, CC 12345</p>
              <p>+1 (555) 123-4567</p>
              <p>hello@thetaste.com</p>
            </div>
          </div>
        </div>

        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 THE TASTE. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
